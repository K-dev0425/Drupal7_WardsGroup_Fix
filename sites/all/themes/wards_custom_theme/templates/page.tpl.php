...
<div id="branding" class="clearfix">
   ...
   <?php
     ...
     if($nid->type == 'job') { ?>
     	<div class="col-sm-10 text-right print-tab"><div class="row ">
   ...
   <?php  } else if($nid->type == 'manifest') {  ?>
    	<div class="col-sm-10 text-right print-tab manifest-tab-box"><div class="row ">
    	<a class="customm-menu-padding" href="?q=dashboard"><h1>Dashbord</h1></a>
			<a href="?q=create-job"><h1>New Job</h1></a>
			<a href="?q=manage-freight/jobs"><h1>Manage Freight</h1></a>
			<a href="?q=scan/updates"><h1>Status Update</h1></a>
      ...
      <button type="button" class="btn btn-default" id="single_Print_fest"> Print Manifest</button>  </div></div>
   <?php  } else if(arg(0) == "manage-freight" && arg(1) == "jobs"){ ?>
		    <div class="col-sm-10 text-right print-tab manifest-tab-box"><div class="row ">
		     <a class="customm-menu-padding" href="?q=dashboard"><h1>Dashbord</h1></a>
				 ...
				 <a href="?q=pricing"><h1>Pricing</h1></a>
				 <a class="customm-menu-padding" href="?q=billing"><h1>Billing</h1></a>
		     <button type="button" class="btn btn-info btn-lg btn-lg-reciever" data-toggle="modal" data-target="#manage-view-job-modal">Show Pickups</button>
			 </div></div>
	   <?php  }
		 else if($nid->type == 'pricing') { ?>
			    <div class="col-sm-10 text-right print-tab manifest-tab-box"><div class="row ">
			     <a class="customm-menu-padding" href="?q=dashboard"><h1>Dashbord</h1></a>
					 <a href="?q=create-job"><h1>New Job</h1></a>
					 <a href="?q=manage-freight/jobs"><h1>Manage Freight</h1></a>
      	...
      	<div class="col-sm-9 text-right print-tab manifest-tab-box">
      	  <div class="row ">
     	    <a class="customm-menu-padding" href="?q=dashboard"><h1>Dashbord</h1></a>
					<a href="?q=create-job"><h1>New Job</h1></a>
					<a href="?q=manage-freight/jobs"><h1>Manage Freight</h1></a>
