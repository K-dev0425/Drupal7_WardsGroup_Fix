 ...
 $get=$_GET['id'];
    ...
    $p=array();
     ...
     foreach($nids as $node_load) {
      ...
      $dis_br_tid=$manifest->field_dispatch_branch['und'][0]['tid'];
      $dis_br_load=taxonomy_term_load($dis_br_tid);
      $dispatch_branch=$dis_br_load->name;

      $create=$manifest->created;
      $created_date=date('m-F-Y',$create);
            ...
            $item_qty+=1;
              ...
              <table style="width:600px;margin:0 auto;color:#333;table-layout:fixed;border-top:1px solid #000;padding-bottom:40px;">
                  ...
                  <tr>
                   ...
                   <tr>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;padding: 2px 12px ;border-left:1px solid #000;"><?php echo $or_name;?></td>
                    <td style="font-family: 'Open Sans';width:200px;font-weight:bold;font-size: 10px;padding: 2px 12px ;border-right:1px solid #000;"><?php echo $des_name;?></td>
                  </tr>
                  <tr>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;padding: 2px 12px ;border-left:1px solid #000;"><?php echo $or_add1;?></td>
                    <td style="font-family: 'Open Sans';width:200px;font-weight:bold;font-size: 10px;padding: 2px 12px ;border-right:1px solid #000;"><?php echo $des_add1;?></td>
                  </tr>
                  <tr>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;padding:2px 12px ;border-left:1px solid #000;"><?php echo $or_add2;?></td>
                    <td style="font-family: 'Open Sans';width:200px;font-weight:bold;font-size: 10px;padding:2px 12px ;border-right:1px solid #000;"><?php echo $des_add2;?></td>
                  </tr>
                  <tr>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;padding:5px 12px ;border-left:1px solid #000;"><?php echo $or_suburb;?></td>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;font-weight:bold;padding:2px 12px ;border-right:1px solid #000;"><?php echo $des_suburb;?></td>
                  </tr>
                  <tr>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;padding:5px 12px ;border-left:1px solid #000;"><?php echo $or_postcode;?></td>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;font-weight:bold;padding:2px 12px ;border-right:1px solid #000;"><?php echo $des_postcode;?></td>
                  </tr>
                  <tr>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;padding:5px 12px ;border-left:1px solid #000;"><?php echo $or_state;?></td>
                  ...
                  <tr>
                    <td style="font-family: 'Open Sans';width:200px;font-size: 10px;padding:5px 12px ;border-left:1px solid #000;"><?php echo $or_phone;?></td>
                  ...
                  <tr>
                    <td colspan="2" style="font-family: 'Open Sans';font-size: 10px;border-top:1px solid #000;padding: 2px 0;">Customer REF : <?php echo $reference;?></td>
                  </tr>
                  <tr>
                    <td colspan="2" style="font-family: 'Open Sans';font-size: 12px;padding: 0 0 20px; ">Instructions:</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="2" style="font-family: 'Open Sans';font-size: 10px;padding: 5px 0;background-color:black;color:white;text-align: center"><b><?php echo $receiver_branch; ?></b><!--<span style="font-size: 13px;">(REC branch)</span>:</td>-->
                  </tr>
                  <tr>
                    <td colspan="2" style="font-family: 'Open Sans';font-size: 15px;border-top:1px solid #ddd;padding: 12px 0 5px;text-align: center"><b> Connote # <?php echo $conote;?></b></td>
                  </tr>
                  <tr>
                 ...
                 print theme('barcode_image', $properties); ?></td>
                  ...
                  <tr>
                    <td style="font-family: 'Open Sans';font-size: 9px;width:200px;padding: 5px 0;border-top:1px solid #000;">ITEM: <span style="font-family: 'Open Sans';font-size:7px;"><?php echo $item_type; ?></span></td>
                    <td style="font-family: 'Open Sans';font-size: 10px;width:200px;padding: 5px 0;border-top:1px solid #000;">Item: <b><?php echo $item_qty;?></b> Of <b><?php echo $item;?></b> QTY</td>
                  </tr>
                  <tr>
                      <td></td>
                    <td style="font-family: 'Open Sans';font-size: 10px;width:200px;padding: 5px 0;">Weight: <b><?php echo $item_weight;?></b></td>
                  </tr>
                  <tr>
                      <td></td>
                    <td style="font-family: 'Open Sans';font-size: 10px;width:200px;padding: 5px 0;">Dimensions:<b><?php echo $item_length.' x '. $item_width.' x '.$item_height;?></b></td>
                  </tr>
                  <tr>
                    <!--ITEM BARCODE-->
                    <td colspan="2" style="font-family: 'Open Sans';font-size: 10px;padding: 2px 0 2px;text-align: center">
                 ...
                 print theme('barcode_image', $properties); ?></td>
                  ...
                  <tr>
                    <td style="font-family: 'Open Sans';font-size: 5px;text-align:center;width:200px;padding: 5px 0;border-top:3px solid #000;">Dispatch Branch : <?php echo $sender_branch;?></td>
                    <td style="font-family: 'Open Sans';font-size: 5px;text-align:center;width:200px;padding: 5px 0;border-top:3px solid #000;"><?php echo date("d-F-Y");?></td>
                  </tr>
              </table>
